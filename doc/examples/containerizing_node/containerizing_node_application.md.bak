...
## Automate aIRChat container creation with spoon.me file

The above container creation and configuration can also be automated using a spoon.me file.
...
Click [here]() for more on spoon.me file syntax.    

Save the file as spoon.me in `C:\spoon\aIRChat`.
