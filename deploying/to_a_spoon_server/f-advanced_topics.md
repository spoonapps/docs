...
1. Navigate to **All Applications** in the Spoon Console.
...
This section explains how to configure Spoon Server's security settings on common Microsoft Windows platforms. These settings restrict external connections to the Administration Site, enable external connections to the Portal Site and enable the Spoon JavaScript API for use with external web portals.
...
<table>
      ...
      <tr>
         <td>
            <p><code>Server.exe /provision</code> <br> <br> &nbsp;&nbsp;&nbsp;&nbsp;Required parameters:<br> &nbsp;&nbsp;&nbsp;&nbsp;[spoon admin email address] <br> <br> &nbsp;&nbsp;&nbsp;&nbsp;Optional parameters:<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/dblibrary&nbsp;</code>[library database connection]<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/dbmanager&nbsp;</code>[manager database connection]<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/adminsite&nbsp;</code>[administration site URL]<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/wwwsite&nbsp;&nbsp;&nbsp;</code>[portal site URL] (creates a new Spoon deployment originating from this server)<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/silent&nbsp;&nbsp;&nbsp;&nbsp;</code>(installs Spoon without user prompt)</p>
         </td>
         <td>
            <p>Creates the Spoon server data and sites.</p>
         </td>
      </tr>
      <tr>
         <td>
         ...
         <td>
            <p>Uninstalls Spoon from this server.</p>
         </td>
      </tr>
      <tr>
         <td>
...
<table>
      ...
      <tr>
         <td>
            <p><code>Server.exe admin /create</code> <br> <br> &nbsp;&nbsp;&nbsp;&nbsp;Required parameters:<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/a&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>[app display name] <br> <br> &nbsp;&nbsp;&nbsp;&nbsp;Required parameters for new version:<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/f&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>[full path to .svm or .spoon file] <br> <br> &nbsp;&nbsp;&nbsp;&nbsp;Required for .svm files:<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/v&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>[app version] <br> <br> &nbsp;&nbsp;&nbsp;&nbsp;Optional for .svm files:<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/lang&nbsp;&nbsp;&nbsp;</code>[IETF code like "en-us"] (default is system language)<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/sku&nbsp;&nbsp;&nbsp;&nbsp;</code>[SKU name] (default is "Default")<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/arch&nbsp;&nbsp;&nbsp;</code>[architecture like <code>x86</code> or <code>x64</code>] (default is <code>AnyCpu</code>)</p>
         </td>
         <td>
...
- **Create a new application with a version from a .spoon file**:

	Server.exe admin /create /f "D:\Installation Files\myapplication.spoon"
...
<table>
      ...
      <tr>
         <td>
            <p><code>Server.exe admin /update</code> <br> <br> &nbsp;&nbsp;&nbsp;&nbsp;Required parameters:<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/f&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>[full path to .svm or .spoon file] <br> <br> &nbsp;&nbsp;&nbsp;&nbsp;Required for .svm files:<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/a&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>[app display name] <br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/v&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>[app version] <br> <br> &nbsp;&nbsp;&nbsp;&nbsp;Optional for .svm files:<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/lang&nbsp;&nbsp;&nbsp;</code>[IETF code like "en-us"] (default is system language)<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/sku&nbsp;&nbsp;&nbsp;&nbsp;</code>[SKU name] (default is "Default")<br> &nbsp;&nbsp;&nbsp;&nbsp;<code>/arch&nbsp;&nbsp;&nbsp;</code>[architecture like <code>x86</code> or <code>x64</code>] (default is <code>AnyCpu</code>)</p>
         </td>
         <td>
...
When publishing applications to external sites, Spoon provides a JavaScript API to enable control over the Spoon Plugin installation, launching applications and deploying applications to the desktop. The following table lists and describes the method calls available in the JavaScript API.
...
<table>
      ...
      <tr>
         ...
         <td>
            <p>Checks whether the Spoon Plugin is installed on the client machine.</p>
         </td>
      </tr>
      <tr>
         <td>
         ...
         <td>
            <p>Prompts user to install the Spoon Plugin.</p>
         </td>
      </tr>
</table>
<br>
...
**Example**: Prompt the user to install the Spoon Plugin if it is not already installed on the machine.
...
The Spoon Feed provides a separate JavaScript API to embed a button within a webpage. This API enables user control over which application to launch and  button appearance. The following table lists and describes the variables that define the Spoon Feed:
...
After the Spoon Variables are set, use the following code to embed the Spoon Feed in an iframe:
...
**Note**: Embedding a Spoon Feed is only available if the server Authentication Type is set to "Anonymous" (see Configuration and Customization).
...
- First, ensure the application has been added to the Start menu
	...
	- Click on the Spoon icon in the task bar
...
When integrating with existing permissions systems, Spoon provides a web service for granting and revoking access to applications. The web service is available as a REST API with the following capabilities:
...
3. Stop Spoon Server. This can be done by opening a Windows Command Prompt as an adminstrator, and entering the command **net stop spoon**

4. Copy all of the data from the current storage path to the new storage path.

5. Restart Spoon Server. This can be done by opening a Windows Command Prompt as an administrator and entering the command **net start spoon**
...
5. If applicable, install the Spoon Console
...
An example case of expected Command Prompt printouts is included, below:
	...
	Owner: EMAILADDRESS=test@spoon.net, CN=myspoonserver, OU=Testing, O=SpoonQA, L=Seattle, ST=Washington, C=US

	Issuer: EMAILADDRESS=test@spoon.net, CN=myspoonserver, OU=Testing, O=SpoonQA, L=Seattle, ST=Washington, C=US
